...
class ResNet_50_CCTT(nn.Module):
    def __init__(self, block=Bottleneck, layers=[3,4,6,3], channels = 64, num_classes=2):
        ...
        self.ViT_1 = ViT(sequence_len = channels*128,c = channels*8,num_patches=8, flag_em=True,flag_mlp=True,dim=288)
        self.ViT_2 = ViT(sequence_len = channels*64,c = channels*8,num_patches=8,flag_em=True,flag_mlp=True,dim=256)
...
if __name__ == '__main__':
    pre_model = ResNet_50_CCTT(Bottleneck, layers=[3,4,6,3],channels = 16).cuda()

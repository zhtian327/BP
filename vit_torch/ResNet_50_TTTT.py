...
class ResNet_50_TTTT(nn.Module):
    def __init__(self, block=Bottleneck, layers=[3,4,6,3], channels = 64, num_classes=2):
        ...
        self.ViT_1 = ViT(sequence_len = channels*32,c = channels,num_patches=8, flag_em=True,flag_mlp=True,dim=256)
        self.ViT_2 = ViT(sequence_len = channels*16,c = channels,num_patches=8,flag_em=True,flag_mlp=True,dim=192)
        self.ViT_3 = ViT(sequence_len = channels*8,c = channels,num_patches=8, flag_em=True,flag_mlp=True,dim=192)
        self.ViT_4 = ViT(sequence_len = channels*4,c = channels,num_patches=8, flag_em=True,flag_mlp=True,dim=128)
...
if __name__ == '__main__':
    pre_model = ResNet_50_TTTT(Bottleneck, layers=[3,4,6,3],channels = 16).cuda()

...
class ResNet_CC_TT(nn.Module):
    def __init__(self, block=Bottleneck, layers=[2,2,2,2], channels = 4, num_classes=2):
        ...
        self.linear1 = nn.Linear(channels * 2, channels)
...
if __name__ == '__main__':
    pre_model = ResNet_CC_TT(Bottleneck, layers=[2,2,2,2], channels = 16).cuda()

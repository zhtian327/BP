...
class ResNet_CCTT(nn.Module):
    def __init__(self, block=Bottleneck, layers=[2,2,2,2], channels = 16, num_classes=2):
        ...
        self.ViT_1 = ViT(sequence_len = channels * 128,c = channels*8,num_patches=8)
        self.ViT_2 = ViT(sequence_len = channels * 64,c = channels*8,num_patches=8)
...
if __name__ == '__main__':
    pre_model = ResNet_CCTT(Bottleneck, layers=[2,2,2,2]).cuda()
